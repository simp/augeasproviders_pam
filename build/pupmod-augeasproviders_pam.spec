%define mod_name augeasproviders_pam

Summary: PAM Augeas-based providers for Puppet
Name: pupmod-augeasproviders_pam
Version: 2.0.1
Release: 0
...
%description
This module provides type/providers for PAM using the Augeas configuration API library.
